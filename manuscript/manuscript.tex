...
systems, occupational heat-safety standards \citep{ISO7243}, and cooling-energy
...
\citep{Kamal2024}, underscoring the need for district-resolved, multi-index
projection.
...
\citep{Chen2016}, LightGBM \citep{Ke2017}, and CatBoost
\citep{Prokhorenkova2018}. Hyperparameters are fixed a~priori and applied
...
radiation. \ph{positioning relative to prior heat-projection studies for
...
support. \ph{contrast with studies that report ML skill without a climatology
baseline.}
...
\ph{link the diurnal-range and coastal-humidity findings to physiological and
epidemiological literature on wet-bulb thresholds.}
...
adaptation responses. \ph{connect UV and oppressive-humidity exposure to health
outcomes and occupational-safety guidance.}
...
over climatology at monthly scale, as discussed above. \ph{compare these
limitations and the horizon choice with dynamical-downscaling and CMIP-based
projection studies.}

\subsection{Outlook}
\ph{future-work paragraph: daily-resolution extension, integration with health
and energy-demand data, and comparison with dynamical projections --- to be
completed with the literature review.}
